    ...
    <section id="company-profile" className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-6">
          <span className="bg-green-400 text-white px-4 py-2 rounded-lg text-sm font-medium inline-block">
            About Us
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Our Vision Box */}
          <div className="bg-green-700 rounded-xl p-8 lg:p-10 text-white">
        ...
        <div className="mt-16 lg:mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Shariah Integrity */}
            <div className="bg-white rounded-xl p-6 text-center border border-green-200">
        ...
        <div className="mt-16 lg:mt-20">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-green-700 h-full top-0"></div>
              ...
              <div className="relative flex items-center">
                <div className="w-1/2 pr-8 text-right">
                  <div className="bg-gray-100 rounded-xl p-6 shadow-sm">
                    <div className="bg-green-700 text-white px-4 py-1.5 rounded-lg text-sm font-medium inline-block mb-3">
                      2009
                    </div>
        ...
        <div className="mt-16 lg:mt-20 bg-gradient-to-br from-[#FFC107]/10 via-[#FFC107]/5 to-white -mx-6 lg:-mx-8 px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Branches:</span> <span className="text-green-600 font-bold">15</span>
                </div>
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Customers:</span> <span className="text-green-600 font-bold">85K+</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Branches:</span> <span className="text-green-600 font-bold">23</span>
                </div>
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Customers:</span> <span className="text-green-600 font-bold">120K+</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Branches:</span> <span className="text-green-600 font-bold">8</span>
                </div>
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Customers:</span> <span className="text-green-600 font-bold">25K+</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Branches:</span> <span className="text-green-600 font-bold">5</span>
                </div>
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Customers:</span> <span className="text-green-600 font-bold">15K+</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Branches:</span> <span className="text-green-600 font-bold">3</span>
                </div>
                <div className="text-sm text-[#333333]">
                  <span className="font-medium">Customers:</span> <span className="text-green-600 font-bold">5K+</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              ...
              <div className="text-3xl lg:text-4xl font-bold text-green-600 mb-2">54+</div>
